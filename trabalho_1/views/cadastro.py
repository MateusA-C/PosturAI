...
import sys
import os
# Isso diz ao Python para olhar também na pasta de cima (a raiz do projeto)
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
from basededadosalchemy import GerenciadorBanco
from criacao_db import session
from datetime import datetime
from criptografa import criptografar_senha,verificar_senha
...
class Cadastro:
    ...
    def validar_e_salvar(self):
        ...
        senha_hash = criptografar_senha(senha=senha)
        self.meu_gerenciador.inserir_usuario(
                                            nome=nome,
                                             idade=idade,
                                             profissao=profissao,
                                             email=email,
        ...
        self.controller.usuario_logado_email = email
